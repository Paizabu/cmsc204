...
public class MyQueueTest {
	...
	public Double g=2.0, h=3.2, i=4.5, j=8.9, k=10.3, l=12.2;
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		try {
			assertEquals("2.03.24.5", doubleQ.toString());
			doubleQ.enqueue(j);
			assertEquals("2.03.24.58.9", doubleQ.toString());
			doubleQ.enqueue(k);
			assertEquals("2.03.24.58.910.3", doubleQ.toString());
		} catch(QueueOverflowException e) {
